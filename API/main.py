...
async def process_image(prompts: dict):
    ...
    You must keep your responses to no nmore than 250 words.
...
async def process_image(prompts: dict):
    ...
    To help you with your evaluation - here are is the lore of each animal you are about to see:
    
    {lore}
    
    Decide carefully and give reasoning in your answer.
